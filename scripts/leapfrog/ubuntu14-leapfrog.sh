...
export OA_OPS_REPO=${OA_OPS_REPO:-'https://github.com/antonym/openstack-ansible-ops.git'}
...
export OA_OPS_REPO_BRANCH=${OA_OPS_REPO_BRANCH:-'f4e9d8e8358e4322abbeda1cf9774ddbe63cde4d'}
